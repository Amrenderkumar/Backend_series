    ...
    return (
        <div className='relative h-screen m-6 rounded-2xl shadow-lg blur-backdrop-md border border-white/30'>
            ...
            <div className='px-6 pl-35'>
                <p className='text-left text-black font-medium  mt-16'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempore praesentium quibusdam <br /> dolores alias.  Saepe excepturi possimus est nulla repellat recusandae ut, porro mollitia aut ullam fuga <br /> nesciunt nisi qui at fugit delectus labore laboriosam quod quibusdam! Aliquid veritatis eligendi officiis!</p>
